...
!       ! Surface values
        ...
        if (isurf == 1) then
            ...
            if (lags) then
              call ncinfo(ncname3(17,:),'an_co2', 'Net CO2 assimilation', 'ug/g m s-1', 'tt0t') !not ppb, see modlsm
              call ncinfo(ncname3(18,:),'resp_co2', 'CO2 respiration soil', 'ug/g m s-1', 'tt0t') !not ppb, see modlsm
            end if
