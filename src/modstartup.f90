...
!      end do
      ...
      call baseprofs ! call baseprofs before calc_halflev Arseni (probably should be here since the density is 0 in advec_kappa subroutine  halflev_kappa(putin,putout))
      ...
      !call baseprofs !call baseprofs Arseni I put it above, after call readrestartfiles
      if(lopenbc) then
        call openboundary_readboundary
      endif
