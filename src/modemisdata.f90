...
!!  \authors Marco de Bruine and Arseni Doyennel, VU
!!  \todo Documentation
!!  \par Revision list
...
module modemisdata
  ...
  integer ::  nullemiss(10)         ! scalars with nullified anthropogenic emissions !Arseni
  ...
  integer :: svco2sum = -1       ! Scalar field which holds the sum of all CO2 sources

  integer, allocatable :: co2fields(:) ! Array defining co2 fields for AGs
